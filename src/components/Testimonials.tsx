const testimonials = [
  { quote: "I lost 30 pounds in 6 months and gained confidence I never knew I had. The trainers at IronForge genuinely care about your progress.", name: "Rachel Kim", info: "Member for 2 years" },
  ...
  { quote: "As a competitive athlete, I need serious equipment and knowledgeable staff. IronForge delivers on both fronts.", name: "Derek Williams", info: "Member for 4 years" },
  ...
  <section id="testimonials" className="py-24 bg-secondary/30">
    <div className="container">
      ...
      <p className="text-muted-foreground max-w-2xl mb-12">
        Hear from members who transformed their lives at IronForge.
      </p>
